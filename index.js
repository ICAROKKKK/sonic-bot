...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=5527992752045 :+5527992752045\n' // ID do WhatsApp + número de telefone
            + 'END:VCARD'
/******END OF VCARD INPUT******/
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '⌛ 𝘊𝘈𝘓𝘔𝘈 𝘈𝘌 𝘔𝘈𝘕,𝘈𝘗𝘙𝘖𝘝𝘌𝘐𝘛𝘈 𝘌 𝘛𝘖𝘔𝘈 𝘜𝘔 𝘊𝘈𝘍𝘌 𝘊𝘖𝘔 𝘉𝘐𝘚𝘊𝘖𝘐𝘛𝘖☕🍪 ⌛',
				success: '✔️ 𝘈𝘌 𝘔𝘌𝘕 𝘛𝘈 𝘗𝘙𝘖𝘕𝘛𝘖 ✔️',
                                levelon: '❬ ✔ ❭ *𝘏𝘈𝘉𝘐𝘓𝘐𝘛𝘈𝘙 𝘓𝘌𝘝𝘌𝘓*',
				leveloff: ' ❬ X ❭  *𝘋𝘌𝘚𝘈𝘉𝘐𝘓𝘐𝘛𝘈𝘙 𝘓𝘌𝘝𝘌𝘓l*',
				levelnoton: '❬ X ❭ *𝘓𝘌𝘝𝘌𝘓 𝘕𝘈𝘖 𝘈𝘛𝘐𝘝𝘖*',
				levelnol: ' *𝘗𝘘𝘗𝘒𝘒𝘒𝘒 𝘓𝘌𝘒 𝘓𝘌𝘝𝘌𝘓* 0 ',
				error: {
					stick: '[❗]  𝙵𝚊𝚕𝚑𝚊,𝚘𝚌𝚘𝚛𝚛𝚎𝚞 𝚞𝚖 𝚎𝚛𝚛𝚘 𝚊𝚘 𝚌𝚘𝚗𝚟𝚎𝚛𝚝𝚎𝚛 𝚊 𝚒𝚖𝚊𝚐𝚎𝚖 𝚎𝚖 𝚞𝚖 𝚊𝚍𝚎𝚜𝚒𝚟𝚘❌',
					Iv: '❌ 𝙻𝚒𝚗𝚔 𝚒𝚟𝚊𝚕𝚒𝚍𝚘 ❌'
				},
				only: {
					group: '[❗] 𝙴𝚜𝚝𝚎 𝚌𝚘𝚖𝚊𝚗𝚍𝚘 𝚜𝚘 𝚙𝚘𝚍𝚎 𝚜𝚎𝚛 𝚞𝚜𝚊𝚍𝚘 𝚎𝚖 𝚐𝚛𝚞𝚙𝚘! ❌',
					ownerG: '[❗]  𝙴𝚜𝚝𝚎 𝚌𝚘𝚖𝚊𝚗𝚍𝚘 𝚜𝚘 𝚙𝚘𝚍𝚎 𝚜𝚎𝚛 𝚞𝚜𝚊𝚍𝚘 𝚙𝚎𝚕𝚘 𝚐𝚛𝚞𝚙𝚘 𝚙𝚛𝚘𝚙𝚛𝚒𝚎𝚝𝚊𝚛𝚒𝚘! ❌',
					ownerB: '[❗] 𝙴𝚜𝚝𝚎 𝚌𝚘𝚖𝚊𝚗𝚍𝚘 𝚜𝚘 𝚙𝚘𝚍𝚎 𝚜𝚎𝚛 𝚞𝚜𝚊𝚍𝚘 𝚙𝚎𝚕𝚘 𝚒𝚌𝚊𝚛𝚘! ❌',
					admin: '[❗] 𝙴𝚜𝚝𝚎 𝚌𝚘𝚖𝚊𝚗𝚍𝚘 𝚜𝚘 𝚙𝚘𝚍𝚎 𝚜𝚎𝚛 𝚞𝚜𝚊𝚍𝚘 𝚙𝚎𝚕𝚘 𝚊𝚍𝚖𝚒𝚗 𝚍𝚘 𝚐𝚛𝚞𝚙𝚘! ❌',
					Badmin: '[❗] 𝙴𝚜𝚝𝚎 𝚌𝚘𝚖𝚊𝚗𝚍𝚘 𝚜𝚘 𝚙𝚘𝚍𝚎 𝚜𝚎𝚛 𝚞𝚜𝚊𝚍𝚘 𝚚𝚞𝚊𝚗𝚍𝚘 𝚘 𝚋𝚘𝚝 𝚜𝚎 𝚝𝚘𝚛𝚖𝚊 𝚊𝚍𝚖𝚒𝚗! ❌',
			...
			const ownerNumber = ["5527992752045@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '5527992752045@s.whatsapp.net'
                        /******ApiKey Input******/
				...
				case 'demote':
                  ...
                  case 'promote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`𝙿𝚊𝚛𝚊𝚋𝚎𝚗𝚜 𝚊𝚐𝚘𝚛𝚊 𝚟𝚌 𝚎 𝚞𝚖 𝚐𝚘𝚍 : @${mentioned[0].split('@')[0]}`, mentioned, true)
						client.groupMakeAdmin(from, mentioned)
					}
					break
				  case 'wa.me':
  ...
  client.updatePresence(from, Presence.composing) 
    ...
    client.sendMessage(from, options, text, { quoted: mek } )
			...
			case 'quotes':
              ...
              case 'owner':
                case 'creator':
                  client.sendMessage(from, {displayname: "𝚒𝚌𝚊𝚛𝚘", vcard: vcard}, MessageType.contact, { quoted: mek})
	...
	case 'kbbi':
		...
		if (args.length < 1) return reply ('*PARCEIROS*: \nEaxy: https://youtube.com/c/EAXYFF\nYamii: https://youtube.com/c/TioYamiiroivemsmpaki\nSaad: https://youtube.com/channel/UCtX3fzhC-teLUpaS7Xz8nKA\nKazuma: https://youtube.com/channel/UChRgBlar0IKGAsseuBeNRgA')
				...
				case 'antilink':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args.length < 1) return reply('𝚍𝚒𝚐𝚒𝚝𝚎 1 𝚙𝚛𝚊 𝚊𝚝𝚒𝚟𝚊𝚛 ')
					if (Number(args[0]) === 1) {
						if (isAntiLink) return reply('𝚘 𝚊𝚗𝚝𝚒-𝚕𝚒𝚗𝚔 𝚎𝚜𝚝𝚊 𝚊𝚝𝚒𝚟𝚊𝚍𝚘')
						antilink.push(from)
				...
				client.updatePresence(from, Presence.composing) 
					...
					mentions('╔══✪〘 Mencionando Todos 〙✪══\n╠➥'+teks+'╚═〘 𝐒𝐎𝐍𝐈𝐂 𝐁𝐎𝐓 〙', members_id, true)
					break
                case 'tagall2':
				client.updatePresence(from, Presence.composing) 
					if (!isGroup) return reply(mess.only.group)
				...
				client.updatePresence(from, Presence.composing) 
					...
					client.sendMessage(from, '╔══✪〘 Mencionando Todos 〙✪══\n╠➥'+teks+'╚═〘 𝐒𝐎𝐍𝐈𝐂 𝐁𝐎𝐓 〙', text, {detectLinks: false, quoted: mek})
					break
                        case 'tagall4':
				client.updatePresence(from, Presence.composing) 
					if (!isGroup) return reply(mess.only.group)
